    ...
    public Receive<Command> createReceive() {
        return newReceiveBuilder()
                .onAnyMessage(message -> {
                    ...
                    while (!hash.substring(0, message.difficulty).equals(target) && nonce < message.getStartNonce()+1000) {
                        nonce++;
...
//                        send the hashresult to the controller return hashResult;
                ...
                }) //since it will receive message on mining
                .build();
    }
